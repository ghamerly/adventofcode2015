...
curl -L -b $cookie_path -o $INPUT https://adventofcode.com/2015/day/$DAY_UNPADDED/input

# use curl to grab the title of today's challenge to put it in the program
TITLE=$(curl https://adventofcode.com/2015/day/$DAY_UNPADDED | \
...
# https://adventofcode.com/2015/day/$DAY_UNPADDED - "$TITLE"
# Author: Greg Hamerly
